...
@section('script-bottom')
    <script>
            ...
            $.ajax({
                ...
                success:function(result){	
                    ...
                    if(!check.checkValidity()){
                        ...
                        if(id){
                            var statment = 'Nama Kelompok Tamu '+name+' Telah Diperbaharui';
                        }else{
                            var statment = 'Nama Kelompok Tamu '+name+' Telah Dibuat';
                        }
        ...
        {
            swal("Anda Yakin Mau Menghapus nama kelompok tamu '"+name+"' ?", {
                icon: "warning",
            }).then((action) => {
                if (action) {
                    $.ajax({
                        url: '{{route("guestgroup.destroy")}}',
                        type: 'GET',
                        cache: false,
                        data:{id: id},
                        success:function(result){
        ...
        <div class="col-md-12">
            <div class="card mb-0">
                <div class="card-header">
                    <h4 class="card-title">Daftar Kelompok Tamu</h4>
