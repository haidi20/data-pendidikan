...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
	<div class="main-menu-content">
		<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
			...
			<li class="nav-item">
				<a href="javascript:;" id="master" class="menu-item"><i class="icon-database"></i> Pengaturan</a>
				<ul class="menu-content">
					<li class="nav-item">
						<a href="{{route('guestgroup.index')}}" id="type_guest" class="menu-item">Kelompok Tamu</a>
					</li>
					<li class="nav-item">
						<a href="{{route('necessity.index')}}" id="necessity" class="menu-item">Keperluan</a>
					</li>
					{{-- <li class="nav-item">
